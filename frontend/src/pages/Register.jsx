        ...
        <section className='flex items-center justify-center'>
            <form onSubmit={onSubmit} className="space-y-4 w-full max-w-md">
                <div>
                    <input
                        type="text" 
                        className="w-full border-2 border-gray-300 rounded-md p-2 focus:border-blue-500 focus:outline-none"                        id='name' 
                        name='name' 
                        value={name} 
                ...
                <div>
                    <input
                        type="email" 
                        className="w-full border-2 border-gray-300 rounded-md p-2 focus:border-blue-500 focus:outline-none"                        id='email' 
                        name='email' 
                        value={email} 
                ...
                <div>
                    <input
                        type="password" 
                        className="w-full border-2 border-gray-300 rounded-md p-2 focus:border-blue-500 focus:outline-none"                        id='password' 
                        name='password' 
                        value={password} 
                ...
                <div>
                    <input
                        type="password" 
                        className="w-full border-2 border-gray-300 rounded-md p-2 focus:border-blue-500 focus:outline-none"                        id='password2' 
                        name='password2' 
                        value={password2} 
                ...
                <div>
                    <button type='submit' className='w-full bg-black text-white rounded-md p-2 hover:bg-gray-400 transition'>Submit</button>
                </div>       
            </form>
        </section>
    </>
